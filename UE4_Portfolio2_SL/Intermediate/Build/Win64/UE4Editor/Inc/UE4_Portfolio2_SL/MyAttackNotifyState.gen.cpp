...
// End Cross Module References
	...
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMyAttackNotifyState_GiveDamage_Statics::NewProp__DamageTo = { "_DamageTo", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MyAttackNotifyState_eventGiveDamage_Parms, _DamageTo), Z_Construct_UClass_APlayerCharacter_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMyAttackNotifyState_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMyAttackNotifyState_GiveDamage, "GiveDamage" }, // 1995006750
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UMyAttackNotifyState, 2885453548);
