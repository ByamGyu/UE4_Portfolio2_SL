...
#define FOREACH_ENUM_EEQUIPMENT_STATE(op) \
	op(EEQUIPMENT_STATE::NONE) \
	op(EEQUIPMENT_STATE::SWORD) \
	op(EEQUIPMENT_STATE::SWORD_AND_SHIELD) \
	op(EEQUIPMENT_STATE::GREATSWORD) 
